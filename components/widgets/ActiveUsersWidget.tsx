...
export default function ActiveUsersWidget({
  ...
  const columns: { col: SortCol | null; label: string; align: string }[] = [
    ...
    { col: "total_bytes_in",  label: "↑ Upp totalt", align: "right" },
    { col: "total_bytes_out", label: "↓ Ned totalt", align: "right" },
    { col: "avg_bps_in",      label: "↑ Upp",        align: "right" },
    { col: "avg_bps_out",     label: "↓ Ned",        align: "right" },
